...
Alcance:
Esta política aplica a todos los colaboradores de la oficina, independientemente de su cargo o antigüedad.
...
reglamento. Para los efectos de contabilizar los quince días, éstos se cuentan de lunes a viernes, pues el sábado y
domingo, además de festivos se considerarán siempre días inhábiles.

Las vacaciones se acumulan de manera proporcional en caso de que el profesional no haya completado un año de
servicio. Antes de cumplir un año de antigüedad laboral, las vacaciones proporcionales sólo se pueden tomar si
existe autorización por parte del empleador.

La normativa y Azerta sugieren que las vacaciones legales no utilizadas en el año deben ser tomadas dentro de los
dos años siguientes, como máximo, para velar por el resguardo del descanso del trabajador o trabajadora.
...
La programación de vacaciones deberá garantizar que las cuentas o trabajos asignados cuenten siempre con, al
menos, una, dos o tres personas responsables activas, según el funcionamiento de cada área, para asegurar la
...
Para vacaciones fuera de esos períodos, será el propio colaborador quien deberá coordinar previamente con sus
equipos y luego presentar su solicitud al líder del área. Una vez validada esa coordinación, podrá registrar su
solicitud en BUK.

Todas las solicitudes deben ser ingresadas con al menos 20 días de anticipación, particularmente en los periodos
de alta demanda.
...
Para la mayoría de los colaboradores de Azerta serán considerados meses de menor demanda: desde el 1
de marzo hasta el 15 de enero; con la excepción de Semana Santa, Vacaciones de Invierno (escolares), Fiestas
Patrias, Navidad, Año Nuevo o cualquier otro feriado que considere en total (días hábiles e inhábiles) más de tres
días.
...
En el caso de que gran parte del equipo de Asuntos Públicos opte por tomarse vacaciones en febrero, la dirección del
...
severa, tienen derecho a solicitar teletrabajo durante el período de vacaciones escolares (Calendario Mineduc),
siempre que la naturaleza de sus funciones lo permita.

Dada la naturaleza de nuestras funciones ese trabajo debe realizarse en Santiago, desde su domicilio.

La solicitud debe realizarse por escrito a la jefatura directa, por lo menos 5 días hábiles antes de que se quiera iniciar
el periodo de teletrabajo. El requerimiento será evaluado caso a caso, considerando tanto la viabilidad de la función
a distancia (reuniones y actividades presenciales, entre otros), como la continuidad operativa del equipo.
...
- Junto con las vacaciones.
- Los días previos y/o posteriores a fines de semana largos.

Para garantizar una adecuada planificación, la solicitud del día administrativo debe realizarse con 5 a 7 días hábiles
de anticipación y considerando el procedimiento para la solicitud de vacaciones previamente señalado. Esto permite
organizarnos y asegurar que las operaciones continúen sin inconvenientes.
